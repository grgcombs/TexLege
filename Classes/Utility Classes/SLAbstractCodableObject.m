...
@implementation SLAbstractCodableObject
...
- (void)setDictionaryRepresentation:(NSDictionary *)dictionaryRepresentation
{
    ...
    __weak SLAbstractCodableObject *weakSelf = self;
    [dictionaryRepresentation enumerateKeysAndObjectsUsingBlock:^(id key, id obj, BOOL *stop) {
        __strong SLAbstractCodableObject *strongSelf = weakSelf;
...
- (NSUInteger)hash
{
    ...
    [[[self class] codableKeysAndClasses] enumerateKeysAndObjectsUsingBlock:^(id key, id obj, BOOL *stop) {
        ...
        current = [SLAbstractCodableObject valueHashForHash:[[strongSelf valueForKey:key] hash] index:hashIndex] ^ current;
        hashIndex++;
